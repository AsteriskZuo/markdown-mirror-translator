...
- 尽量保护 fenced code block、indented code block、inline code、URL、frontmatter、HTML block、pipe table 等 Markdown 结构。
...
- 免费 Provider 的翻译请求超过 30 秒未响应会自动超时，并自动重试一次后才判定失败。
